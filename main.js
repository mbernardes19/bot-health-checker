...
bot.command('msr', async ctx => {
    try {
        ...
        await axios.get('http://bot.sosvestibular.com/Health/Health/revive')
...
bot.command('msrf', async ctx => {
    try {
        ...
        await axios.get('http://bot.sosvestibular.com/HealthGratuito/HealthGratuito/revive')
      ...
      try {
        ...
        if (!messageSempreRicoAnswered) {
            ...
            try {
                ...
                await axios.get('http://bot.sosvestibular.com/HealthTeste/HealthTeste/revive')
